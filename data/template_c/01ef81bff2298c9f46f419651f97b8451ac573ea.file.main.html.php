<?php /* Smarty version Smarty-3.1.16, created on 2016-03-28 17:38:25
         compiled from "tpl\admin\main.html" */ ?>
<?php /*%%SmartyHeaderCode:2056256f3b30e23d499-73541824%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '01ef81bff2298c9f46f419651f97b8451ac573ea' => 
    array (
  ...
  'nocache_hash' => '2056256f3b30e23d499-73541824',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_56f3b30e4026f2_01166292',
  'variables' => 
  array (
    'userName' => 0,
    'weixinInfo' => 0,
...
<?php if ($_valid && !is_callable('content_56f3b30e4026f2_01166292')) {function content_56f3b30e4026f2_01166292($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>微信管理后台-测试环境</title>
<link rel="stylesheet" href="Admin/login/css/main.css?v=20150435" type="text/css" media="screen" />
...
<script type="text/javascript" src="Admin/login/js/common.js?v=20150117"></script>
</head>
<body>
...
<div class="layout_top_header">
    ...
    <div id = "ad_setting" class="ad_setting2">
        ...
        <ul class="dropdown-menu-uu" style="display: none" id="ad_setting_ul">
            <li class="ad_setting_ul_li"> <a href="../../Admin/login/adminEdit.php" target="menuFrame">
...
<div class="layout_left_menu">
    <ul id="menu">
        <li class="childUlLi">
            <a href="tpl/admin/main1.html"  target="menuFrame"><i class="glyph-icon icon-home"></i>首页</a>
            <ul>
                <li><a target="menuFrame" href="javascript:void(0)"><i class="glyph-icon icon-chevron-right"></i>管理公众号</a>
                    ...
                    <li><a href="../../Admin/login/adminSetMuneClass.php" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>菜单分类设置</a>
                    </li>
            </ul>
        </li>
        <li class="childUlLi">
        ...
        <li class="childUlLi">
            ...
            <ul>
                <?php if ($_smarty_tpl->tpl_vars['userName']->value=="admin") {?>
                    ...
                    <li><a href="../../Admin/login/adminUserSearch.php" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>管理员权限用户查询</a></li>
                    <li><a href="../../Admin/login/addUserByAdmin.php" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>管理员权限用户添加</a></li>
                <?php }?>
                <li><a href="../../Admin/login/adminEdit.php" target="menuFrame">
...
<div id="layout_right_content" class="layout_right_content">
    <div class="mian_content">
        <div id="page_content">
            <iframe id="menuFrame" name="menuFrame" src="tpl/admin/main1.html" style="overflow:visible;"
                scrolling="yes" frameborder="no" width="100%" height="100%"></iframe>
        </div>
    </div>
</div>
<div class="layout_footer">
    <p>Copyright © 2015 - 臭臭喵工作室</p>
</div>
<script>
