...
function getCity(){
	...
	//通过百度链接，根据IP查城市
	$content = file_get_contents("http://api.map.baidu.com/location/ip?ak=7IZ6fgGEGohCrRKUE9Rj4TSQ&ip={$vipIP}&coor=bd09ll");
	$json = json_decode($content);
	return $city = $json->{'content'}->{'address'};//按层级关系提取address数据
}
